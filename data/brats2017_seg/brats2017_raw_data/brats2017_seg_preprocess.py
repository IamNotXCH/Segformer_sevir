...
if __name__ == "__main__":
    ...
    brats2017_task1_prep = Brats2017Task1Preprocess(
        root_dir=os.path.abspath("d:/sc/science/SegFormer3D/data/brats2017_seg/brats2017_raw_data"),  # 修改为绝对路径
        train_folder_name="train",
        save_dir=os.path.abspath("d:/sc/science/SegFormer3D/data/brats2017_seg/BraTS2017_Training_Data")  # 指定正确的保存路径
    )
    # 运行预处理管道 
